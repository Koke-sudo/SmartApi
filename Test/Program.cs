...
namespace Test
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Id=1001, Name="汤宇航", Sex=true};
            //Students s = redis.StringGet<Students>("name");
            redis.
            //Console.WriteLine($"{s.Id},{s.Name},{s.Sex}");
            Console.ReadKey();
        }
        public class Redis
        {
            ...
            private readonly IDatabase _db = ConnMultiplexer.GetDatabase(1);
